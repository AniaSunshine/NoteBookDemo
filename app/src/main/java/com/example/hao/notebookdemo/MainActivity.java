...
public class MainActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        SimpleCursorAdapter simpleCursorAdapter=new SimpleCursorAdapter(MainActivity.this,R.layout.list_item,cursor,new String[]{DBHelper.CONTENT},new int[]{R.id.tv_info},0);
